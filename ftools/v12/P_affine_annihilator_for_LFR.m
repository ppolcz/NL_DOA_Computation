...
%  VISSZA:    2020.05.20. (május 20, szerda), 01:54
%  `N_times_PI' --> plfr(N_times_PI',vars_lfr)'   ---> nem biztos, hogy minden benne van
%  MODOSITVA: 2020.05.27. (május 27, szerda), 21:49
%  `N_times_PI' --> plfr(N_times_PI',PI.vars)'
[N_ThetaT,~,samples,sampleserr,err] = P_constKer_for_LFR(plfr(N_times_PI',PI.subsvars), 'proj', args.proj,...
